...
const transferSchema = yup.object({
  sourceAccountId: yup.string().min(1, "Source account is required"),
  destinationAccountId: yup.string().min(1, "Destination account is required"),
  amount: yup.number().positive("Amount must be positive"),
  description: yup.string().optional(),
});

const TransferPanel = ({ onTransferSuccess }) => {
  ...
  const formatCurrency = (accountId) => {
